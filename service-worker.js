...
const ESSENTIAL_SHELL = ['./', './index.html', './manifest.json', './production.css', './food-data.js', './supabase-cloud.js', './auth-onboarding.js', './cloud-auth-bridge.js', './admin-ui.js', './admin-dashboard.css', './core-storage.js', './exercise-library.js', './app-production.js', './health-sync.js', './navigation-fix.js', './build-live.js', './icons/icon-192.png', './apple-touch-icon.png'];
