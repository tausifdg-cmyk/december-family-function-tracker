...
const ESSENTIAL_SHELL = ['./', './index.html', './manifest.json', './production.css', './food-data.js', './auth-onboarding.js', './core-storage.js', './exercise-library.js', './app-production.js', './health-sync.js', './navigation-fix.js', './build-live.js', './supabase-cloud.js', './admin-ui.js', './admin-dashboard.css', './icons/icon-192.png', './apple-touch-icon.png'];
