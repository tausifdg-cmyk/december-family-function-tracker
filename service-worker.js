const CACHE='december-tracker-v2';
const ASSETS=['./','./index.html','./style.css','./app.js','./plan.js','./manifest.json','./data/plan.json','./data/exercises.json','./icons/icon-192.svg','./icons/icon-512.svg'];
