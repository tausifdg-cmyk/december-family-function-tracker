...
const ESSENTIAL_SHELL = ['./', './index.html', './manifest.json', './production.css', './coach.css', './phase2.css', './workout-redesign.css', './today-redesign.css', './phase3.css', './phase4.css', './phase5.css', './experience-core.css', './experience-v2.css', './share-gallery-upgrade.css', './ui-corrections.css', './media-diet-upgrade.css', './food-data.js', './supabase-cloud.js', './auth-onboarding.js', './cloud-auto-connect.js', './login-forgot-password.js', './admin-ui.js', './profile-dropdown.js', './admin-dashboard.css', './core-storage.js', './coach-engine.js', './coach-guard.js', './coach-ui.js', './performance-guard.js', './phase2.js', './workout-redesign.js', './today-redesign.js', './phase3.js', './phase4.js', './phase5.js', './experience-core.js', './experience-state.js', './experience-coach-actions.js', './experience-food.js', './experience-workout.js', './experience-progress.js', './experience-launch.js', './experience-telemetry.js', './share-gallery-upgrade.js', './ui-corrections.js', './media-diet-upgrade.js', './youtube-legacy-recovery.js', './ios-health-upgrade.js', './exercise-library.js', './app-production.js', './health-sync.js', './navigation-fix.js', './build-live.js', './icons/icon-192.png', './apple-touch-icon.png'];
