...
const APP_SHELL = ['./', './index.html', './latest.html', './manifest.json', './style.css', './production.css', './food-data.js', './auth-onboarding.js', './core-storage.js', './app-production.js', './navigation-fix.js', './build-live.js', './icons/icon-192.png', './apple-touch-icon.png'];
