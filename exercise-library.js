(function () {
  ...
  const exercises = [
    ...
    ['dumbbell-chest-fly', 'Dumbbell Chest Fly', ['chest fly', 'cable fly', 'incline fly', 'incline dumbbell fly', 'decline twist fly'], 'Chest', 'Dumbbells • bench', 'chest', 'fly', ['Keep a soft elbow bend', 'Open only to a comfortable depth', 'Bring arms together with control']],
